      ...
      {!loading && (
        <>
          <div className="hidden lg:flex w-full items-start">
            {/* Left side - Details */}
            <div className="w-100 bg-white shadow-lg shadow-black rounded-lg h-60 p-4 ml-18">
          ...
          {/* Right side - Prizes */}
            <div className="w-100 bg-white shadow-lg rounded-lg shadow-black h-60 p-4 mr-18">
        ...
        <div className="lg:hidden max-w-3xl mx-auto px-4">
          ...
          {/* Mobile Leaderboard */}
          <div className="bg-white rounded-lg shadow-lg shadow-black p-6">
            <h2 className="text-3xl font-extrabold mb-4 text-center">Leaderboard</h2>
            <h2 className="text-xl font-lightbold mb-4 text-center">Updated as of end of day Monday</h2>
